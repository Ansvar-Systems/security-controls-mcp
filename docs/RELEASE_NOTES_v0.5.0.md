# Release Notes - v0.5.0 (2026-02-12)
...
v0.5.0 represents a major capability enhancement, enabling automated extraction from diverse security standards across IT, OT, automotive, privacy, and AI domains. The extensible architecture makes it easy to add new extractors while maintaining high quality through comprehensive testing.
